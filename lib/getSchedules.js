...
const baseUrl = "https://c.np.fm/cgi-bin/cbgrn/grn.cgi/schedule/group_day?type_search=user&search_text=tanoue&gid=search"
...
const getSchedules = async () => {
  ...
  const mySchedules = Array.from(html.querySelectorAll('.normalEventElement'));
  ...
  const formattedMySchedules = mySchedules
    ...
    .filter(({ url }) => !url.match(/attention/))
